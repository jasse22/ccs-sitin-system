...
try {
    // 1. We join on your student relation keys and isolate feedback messages
    $sql = "SELECT n.*, CONCAT(s.firstname, ' ', s.lastname) AS student_name 
...
<head>
    ...
    <style>
        :root {
            --nav-bg: #1e3a5f;      /* Navy Blue */
            --primary-blue: #3498db; /* Action Blue */
            --logout-red: #e74c3c;   /* Log out Red */
            --table-header: #2c3e50;
            --bg-light: #f4f7f6;
        }
    ...
    <div class="feedback-card">
        ...
        <table>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="3" style="text-align:center; padding: 30px; color: #718096;">No student feedback reported yet.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
