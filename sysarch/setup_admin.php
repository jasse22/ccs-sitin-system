<?php
// ============================================================
//  setup_admin.php — Run this ONCE to fix admin password
...
a.btn{display:inline-block;margin-top:16px;background:#1e3a5f;color:#fff;padding:10px 24px;border-radius:6px;text-decoration:none;font-weight:600;font-size:14px;}
</style>
</head>
<body>
<?php if ($verified): ?>
...
<?php else: ?>
  <div class="err">❌ Account <?= $action ?> but password verification FAILED.</div>
<?php endif; ?>
<table>
...
<div class="warn">⚠️ <strong>Delete this file after use!</strong></div>
